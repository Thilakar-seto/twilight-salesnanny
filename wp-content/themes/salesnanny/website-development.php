   ...
   <section class="hero hero-d">
      ...
      <div class="container hero-d__container">
         <div class="hero-d__content" data-aos="fade-right" data-aos-duration="900">
            <h1 class="hero-d__h1">Get a Website That <span class="hero-d__h1-red">Works for Your Business</span> 24/7</h1>
            <p class="hero-d__desc">
               Fast, modern, and conversion-focused websites designed to attract visitors, build trust, and turn traffic into qualified inquiries.
            </p>
      ...
      <div class="container">
         <div class="row align-items-end mb-5">
            <div class="col-lg-6" data-aos="fade-up">
               <h2 class="section-title">CORE WEBSITE DEVELOPMENT <span>SOLUTIONS</span></h2>
            </div>
            <div class="col-lg-5 offset-lg-1" data-aos="fade-up" data-aos-delay="100">
               <p class="section-sub">We don't just design pretty websites, we build digital assets that load fast, rank on search engines, and convert visitors into customers.</p>
            </div>
         </div>
         <div class="row g-4 mb-4">
            <div class="col-lg-5" data-aos="fade-up" data-aos-delay="50">
               <div class="service-img-wrap">
                  <img src="https://images.unsplash.com/photo-1553413077-190dd305871c?auto=format&fit=crop&q=80&w=900" alt="Website strategy and planning">
                  ...
                  <div style="position:absolute;bottom:24px;left:24px;z-index:2;">
                     ...
                     <div style="font-family:'Inter',sans-serif;font-size:22px;font-weight:800;color:#fff;">Modern Business Websites</div>
                  </div>
               </div>
            </div>
            <div class="col-lg-7" data-aos="fade-up" data-aos-delay="100">
               <div class="service-img-wrap">
                  <img src="https://images.unsplash.com/photo-1471440671318-55bdbb772f93?auto=format&fit=crop&q=80&w=900" alt="Website development and launch">
                  <div class="service-img-overlay"></div>
                  <div style="position:absolute;bottom:24px;left:24px;z-index:2;">
                     <div style="font-size:0.75rem;color:rgba(255,255,255,0.6);text-transform:uppercase;letter-spacing:1px;">Program</div>
                     <div style="font-family:'Inter',sans-serif;font-size:22px;font-weight:800;color:#fff;">High-Performing Web Platforms</div>
                  </div>
               </div>
            </div>
         </div>
         <div class="row g-4 align-items-center services-grid-compact">
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="100">
               <div class="service-card w-100">
                  ...
                  <p>Professional, modern websites that represent your brand and convert visitors into qualified leads.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="150">
               <div class="service-card w-100">
                  ...
                  <p>Full-featured online stores with payment integration, inventory management, and conversion-optimized checkout.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="200">
               <div class="service-card w-100">
                  ...
                  <h4>Landing Pages</h4>
                  <p>High-converting single-page sites built for ad campaigns, lead generation, and product launches.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="250">
               <div class="service-card w-100">
                  ...
                  <p>Tailor-made web platforms designed around your unique business workflows and customer needs.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="300">
               <div class="service-card w-100">
                  ...
                  <h4>Website Redesign &amp; Revamp</h4>
                  <p>Modernize outdated websites with a fresh design, improved speed, and a better user experience.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="350">
               <div class="service-card w-100">
                  ...
                  <p>Ongoing updates, security, backups, and performance monitoring to keep your site running smoothly.</p>
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="col-lg-5" data-aos="fade-right">
               <div class="position-relative">
                  <div class="about-img-grid">
                     <img src="https://images.unsplash.com/photo-1578575437130-527eed3abbec?auto=format&fit=crop&q=80&w=900" alt="Website development team collaboration" style="height:220px;object-fit:cover;">
                     <img src="https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?auto=format&fit=crop&q=80&w=500" alt="UI and UX design planning" style="height:160px;object-fit:cover;">
                     <img src="https://images.unsplash.com/photo-1565728744382-61accd4aa148?auto=format&fit=crop&q=80&w=500" alt="Website optimization workshop" style="height:160px;object-fit:cover;">
                  </div>
               </div>
            </div>
            <div class="col-lg-6 offset-lg-1" data-aos="fade-left">
               <h2 class="section-title" style="color:#fff;">Why Your Website Matters More Than Ever?</span></h2>
               <p style="color:rgba(255,255,255,0.6);font-size:1rem;line-height:1.75;margin:20px 0 36px;font-weight:300;">Your website is the first impression most customers will have of your business. Make it count.</p>
               <div class="about-check-item">
                  <div class="check-icon"><i class="fas fa-check"></i></div>
                  <div>
                     <h6>Your Website = Your Storefront</h6>
                     <p>75% of customers judge your credibility based on your website design. A weak site loses leads before you even meet them.</p>
                  </div>
               </div>
               <div class="about-check-item">
                  <div class="check-icon"><i class="fas fa-check"></i></div>
                  <div>
                     <h6>Speed and Mobile Experience Decide Conversions</h6>
                     <p>A 1-second delay drops conversions by 7%. Slow, clunky sites lose customers to faster competitors.</p>
                  </div>
               </div>
               <div class="about-check-item">
                  <div class="check-icon"><i class="fas fa-check"></i></div>
                  <div>
                     <h6>A Good Website Sells While You Sleep</h6>
                     <p>The right design, content, and structure turn your website into a 24/7 salesperson.</p>
                  </div>
               </div>
   ...
   <section id="process" class="process-section">
      <div class="container">
         <div class="text-center mb-5" data-aos="fade-up">
            <h2 class="section-title">What Can a High-Performing Website <span>Do for Your Business?</span></h2>
            <p class="section-sub mx-auto mt-3">A well-built website doesn't just look good, it actively grows your business. Here's what to expect:</p>
         </div>
         <div class="row g-4">
            <div class="col-md-6 col-lg-3 d-flex" data-aos="fade-up" data-aos-delay="50">
               <div class="process-step-card w-100">
                  ...
                  <h4>Faster Load Speeds &amp; Better Rankings</h4>
                  <p>Optimized for Google's Core Web Vitals to rank higher and convert better.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-3 d-flex" data-aos="fade-up" data-aos-delay="100">
               <div class="process-step-card w-100">
                  ...
                  <p>Responsive design that looks and works perfectly on every device.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-3 d-flex" data-aos="fade-up" data-aos-delay="150">
               <div class="process-step-card w-100">
                  ...
                  <p>Strategic layout, clear CTAs, and trust signals turn visitors into leads.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-3 d-flex" data-aos="fade-up" data-aos-delay="200">
               <div class="process-step-card w-100">
                  ...
                  <h4>Secure, Scalable, and Future-Ready</h4>
                  <p>Built on modern frameworks with security, scalability, and easy updates in mind.</p>
               </div>
            </div>
         </div>
      </div>
   ...
   <section class="demand-map-section">
      <div class="container">
         <div class="demand-map-header" data-aos="fade-up">
            <h2 class="demand-map-title">The Difference a Modern Website <span>Makes for Your Business</span></h2>
            <p class="demand-map-desc">Before: slow, outdated, and confusing. After: fast, trustworthy, and built to convert.</p>
         </div>
         <div class="demand-map-layout">
            <div class="demand-map-column demand-map-left" data-aos="fade-right">
               <article class="demand-map-card">
                  <h4>Slow Loading &amp; Outdated Design</h4>
                  <p>Visitors leave before the page even opens.</p>
               </article>
               <article class="demand-map-card">
                  <h4>Weak Mobile Experience</h4>
                  <p>Most visitors give up on phones.</p>
               </article>
               <article class="demand-map-card">
                  <h4>No Clear Path to Conversion</h4>
                  <p>Visitors don't know what to do next.</p>
               </article>
            </div>
            <div class="demand-map-center" data-aos="zoom-in" data-aos-delay="80">
               <div class="demand-phone" aria-hidden="true">
                  <div class="demand-phone-screen">
                     <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/home1.webp' ); ?>" alt="Website transformation visual">
                  </div>
               </div>
            </div>
            <div class="demand-map-column demand-map-right" data-aos="fade-left">
               <article class="demand-map-card">
                  <h4>Fast, Modern, Trustworthy Design</h4>
                  <p>First impressions that win customers.</p>
               </article>
               <article class="demand-map-card">
                  <h4>Perfect Across All Devices</h4>
                  <p>Smooth experience on mobile, tablet, and desktop.</p>
               </article>
               <article class="demand-map-card">
                  <h4>Built to Convert</h4>
                  <p>Strategic layout that turns traffic into leads.</p>
               </article>
            </div>
         </div>
      </div>
            ...
            <div class="col-lg-5" data-aos="fade-right">
               <div class="faq-split-visual">
                  ...
                  <div class="faq-img-wrap">
                     <img src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=900" alt="Website development strategy discussion">
                  ...
                  <div class="faq-list" id="maintFaqList">
                     <div class="faq-item">
                        <div class="faq-header">
                           <p class="faq-question">Why does my business need a professional website?</p>
                           <i class="fas fa-chevron-down faq-icon" aria-hidden="true"></i>
                        </div>
                        <div class="faq-answer">
                           <p>Website development is the process of creating, building, and maintaining websites that help businesses improve digital presence, customer engagement, and online visibility.</p>
                        </div>
                     </div>
                     <div class="faq-item">
                        <div class="faq-header">
                           <p class="faq-question">Can a website help generate business inquiries?</p>
                           <i class="fas fa-chevron-down faq-icon" aria-hidden="true"></i>
                        </div>
                        <div class="faq-answer">
                           <p>Yes. A well-structured website helps customers understand your services clearly and makes it easier for them to connect and inquire about your business.</p>
                        </div>
                     </div>
                     <div class="faq-item">
                        <div class="faq-header">
                           <p class="faq-question">What difference does a website make for my business?</p>
                           <i class="fas fa-chevron-down faq-icon" aria-hidden="true"></i>
                        </div>
                        <div class="faq-answer">
                           <p>A professional website helps your business stay active online 24/7, making it easier for customers to discover your services, build trust, and connect with your business anytime.</p>
                        </div>
                     </div>
                     <div class="faq-item">
                        <div class="faq-header">
                           <p class="faq-question">What happens if my business does not have a strong website presence?</p>
                           <i class="fas fa-chevron-down faq-icon" aria-hidden="true"></i>
                        </div>
                        <div class="faq-answer">
                           <p>Customers may move toward competitors who provide better digital experiences, clearer information, and easier ways to connect online.</p>
                        </div>
                     </div>
                     <div class="faq-item">
                        <div class="faq-header">
                           <p class="faq-question">How does website development support long-term business growth?</p>
                           <i class="fas fa-chevron-down faq-icon" aria-hidden="true"></i>
                        </div>
                        <div class="faq-answer">
                           <p>A professionally developed website helps your business stay active online, improve customer trust, support marketing efforts, and create long-term digital visibility.</p>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="col-lg-5" data-aos="fade-right">
               ...
               <ul class="contact-keypoints list-unstyled mb-0">
                  <li class="contact-keypoints__item">
                     <div>
                        <strong class="contact-keypoints__title">Conversion-First Design</strong>
                     </div>
                  </li>
                  <li class="contact-keypoints__item">
                     <div>
                        <strong class="contact-keypoints__title">Mobile &amp; Speed Optimized</strong>
                     </div>
                  </li>
                  <li class="contact-keypoints__item">
                     <div>
                        <strong class="contact-keypoints__title">SEO-Ready From Day One</strong>
                     </div>
                  </li>
                  <li class="contact-keypoints__item">
                     <div>
                        <strong class="contact-keypoints__title">Dedicated Project Manager</strong>
                     </div>
                  </li>
               </ul>
            </div>
   ...
   <script>
      (function () {
          ...
          form.addEventListener('submit', function (e) {
            ...
            formData.append('form-field-d0e86ec', company ? company : 'Website Development \u2014 Contact Form');
