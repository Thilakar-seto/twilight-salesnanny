   ...
   <section class="hero hero-d">
      ...
      <div class="container hero-d__container">
         <div class="hero-d__content" data-aos="fade-right" data-aos-duration="900">
            <h1 class="hero-d__h1">Capture Attention Faster with High-Impact Creative Content</h1>
            <p class="hero-d__desc">
               We help businesses build strong visual content that grabs attention, communicates clearly, and turns viewers into customers through strategic design, video, and creative storytelling.
            </p>
      ...
      <div class="container">
         <div class="row align-items-end mb-5">
            <div class="col-lg-6" data-aos="fade-up">
               <h2 class="section-title">Core Creatives Solutions for <span>Your Business</span></h2>
            </div>
            <div class="col-lg-5 offset-lg-1" data-aos="fade-up" data-aos-delay="100">
               <p class="section-sub">We don't just create visuals, we build creative content that helps your brand stand out, connect with the right audience, and improve marketing performance across every platform.</p>
            </div>
         </div>
         <div class="row g-4 mb-4">
            <div class="col-lg-5" data-aos="fade-up" data-aos-delay="50">
               <div class="service-img-wrap">
                  <img src="https://images.unsplash.com/photo-1553413077-190dd305871c?auto=format&fit=crop&q=80&w=900" alt="Creative strategy and design planning">
                  ...
                  <div style="position:absolute;bottom:24px;left:24px;z-index:2;">
                     ...
                     <div style="font-family:'Inter',sans-serif;font-size:22px;font-weight:800;color:#fff;">Creative Content Strategy</div>
                  </div>
               </div>
            </div>
            <div class="col-lg-7" data-aos="fade-up" data-aos-delay="100">
               <div class="service-img-wrap">
                  <img src="https://images.unsplash.com/photo-1471440671318-55bdbb772f93?auto=format&fit=crop&q=80&w=900" alt="Creative production and brand storytelling">
                  <div class="service-img-overlay"></div>
                  <div style="position:absolute;bottom:24px;left:24px;z-index:2;">
                     <div style="font-size:0.75rem;color:rgba(255,255,255,0.6);text-transform:uppercase;letter-spacing:1px;">Program</div>
                     <div style="font-family:'Inter',sans-serif;font-size:22px;font-weight:800;color:#fff;">Performance Creative System</div>
                  </div>
               </div>
            </div>
         </div>
         <div class="row g-4 align-items-center services-grid-compact">
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="100">
               <div class="service-card w-100">
                  ...
                  <p>Strengthen your brand presence online through social media creatives, ad designs, banners, posters, and digital assets designed to capture attention and improve audience engagement.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="150">
               <div class="service-card w-100">
                  ...
                  <p>Communicate your brand story more effectively through product videos, brand films, advertisements, and explainer content that keep viewers engaged and drive customer interest.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="200">
               <div class="service-card w-100">
                  ...
                  <p>Capture attention faster through creative animations, reels, and motion content designed to stand out in crowded social media feeds and digital campaigns.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="250">
               <div class="service-card w-100">
                  ...
                  <h4>Photography</h4>
                  <p>Build a more professional and trustworthy brand image through high-quality product shoots, lifestyle photography, and branded visual content.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="300">
               <div class="service-card w-100">
                  ...
                  <h4>Ad Creative Design</h4>
                  <p>Improve campaign performance through conversion-focused creatives built for Meta, Google, LinkedIn, and YouTube advertising platforms.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="350">
               <div class="service-card w-100">
                  ...
                  <p>Present your business more professionally through brochures, pitch decks, reports, and branded documents that strengthen credibility and customer confidence.</p>
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="col-lg-5" data-aos="fade-right">
               <div class="position-relative">
                  <div class="about-img-grid">
                     <img src="https://images.unsplash.com/photo-1578575437130-527eed3abbec?auto=format&fit=crop&q=80&w=900" alt="Creative team collaboration" style="height:220px;object-fit:cover;">
                     <img src="https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?auto=format&fit=crop&q=80&w=500" alt="Visual content planning" style="height:160px;object-fit:cover;">
                     <img src="https://images.unsplash.com/photo-1565728744382-61accd4aa148?auto=format&fit=crop&q=80&w=500" alt="Creative workshop session" style="height:160px;object-fit:cover;">
                  </div>
               </div>
            </div>
            <div class="col-lg-6 offset-lg-1" data-aos="fade-left">
               <h2 class="section-title" style="color:#fff;">Why Strong Creative Matters for Your Business?</span></h2>
               <p style="color:rgba(255,255,255,0.6);font-size:1rem;line-height:1.75;margin:20px 0 36px;font-weight:300;">Customers see hundreds of posts, ads, and videos every day. Strong creative is what helps your business stand out, hold attention, and create a lasting impression.</p>
               <div class="about-check-item">
                  <div class="check-icon"><i class="fas fa-check"></i></div>
                  <div>
                     <h6>Creative Decides First Impressions</h6>
                     <p>The first few seconds of a visual or video often determine whether customers engage with your business or scroll away.</p>
                  </div>
               </div>
               <div class="about-check-item">
                  <div class="check-icon"><i class="fas fa-check"></i></div>
                  <div>
                     <h6>Better Creative Improves Marketing Results</h6>
                     <p>High-quality visuals and videos help campaigns perform better by increasing engagement, clicks, and customer interest.</p>
                  </div>
               </div>
               <div class="about-check-item">
                  <div class="check-icon"><i class="fas fa-check"></i></div>
                  <div>
                     <h6>Visual Storytelling Builds Brand Connection</h6>
                     <p>Customers remember brands that communicate through strong visuals, emotions, and memorable stories instead of plain messaging alone.</p>
                  </div>
               </div>
               <a href="#contact" class="btn-primary-hero mt-4" style="margin-top:36px;">
               See Strong Creative <i class="fas fa-arrow-right"></i>
               </a>
            </div>
         </div>
      </div>
   ...
   <section id="process" class="process-section">
      <div class="container">
         <div class="text-center mb-5" data-aos="fade-up">
            <h2 class="section-title">What High-Quality Creative Delivers <span>for Businesses?</span></h2>
            <p class="section-sub mx-auto mt-3">Strong creatives do more than make your brand look good, they improve how customers respond to your business across every marketing channel.</p>
         </div>
         <div class="row g-4">
            <div class="col-md-6 col-lg-3 d-flex" data-aos="fade-up" data-aos-delay="50">
               <div class="process-step-card w-100">
                  ...
                  <h4>More Attention from the Right Audience</h4>
                  <p>Scroll-stopping visuals help your business stand out in crowded social feeds and competitive markets.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-3 d-flex" data-aos="fade-up" data-aos-delay="100">
               <div class="process-step-card w-100">
                  ...
                  <h4>Higher Engagement &amp; Better Interaction</h4>
                  <p>Strong creative encourages more clicks, shares, comments, and customer engagement across campaigns and platforms.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-3 d-flex" data-aos="fade-up" data-aos-delay="150">
               <div class="process-step-card w-100">
                  ...
                  <h4>Better Ad Performance &amp; Lower Costs</h4>
                  <p>Well-designed creatives improve campaign efficiency and help reduce wasted ad spend.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-3 d-flex" data-aos="fade-up" data-aos-delay="200">
               <div class="process-step-card w-100">
                  ...
                  <h4>A More Professional Brand Presence</h4>
                  <p>Consistent and polished visuals build stronger customer trust and position your business more professionally in the market.</p>
               </div>
            </div>
         </div>
      </div>
   ...
   <section class="demand-map-section">
      <div class="container">
         <div class="demand-map-header" data-aos="fade-up">
            <h2 class="demand-map-title">The Difference Strong Creative <span>Makes for Your Business</span></h2>
            <p class="demand-map-desc">From generic visuals and weak engagement to memorable creative that improves campaign performance and brand recall.</p>
         </div>
         <div class="demand-map-layout">
            <div class="demand-map-column demand-map-left" data-aos="fade-right">
               <article class="demand-map-card">
                  <h4>Generic &amp; Forgettable Content</h4>
                  <p>Posts and advertisements blend in with competitors and fail to leave a lasting impression.</p>
               </article>
               <article class="demand-map-card">
                  <h4>Inconsistent Brand Visuals</h4>
                  <p>Different styles, colors, and messaging weaken your brand identity and confuse customers.</p>
               </article>
               <article class="demand-map-card">
                  <h4>Low Engagement &amp; Weak Campaign Results</h4>
                  <p>Creative content fails to attract attention, generate interaction, or support marketing performance.</p>
               </article>
            </div>
            <div class="demand-map-center" data-aos="zoom-in" data-aos-delay="80">
               <div class="demand-phone" aria-hidden="true">
                  <div class="demand-phone-screen">
                     <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/home1.webp' ); ?>" alt="Creative transformation visual">
                  </div>
               </div>
            </div>
            <div class="demand-map-column demand-map-right" data-aos="fade-left">
               <article class="demand-map-card">
                  <h4>Attention-Grabbing Visual Content</h4>
                  <p>Creative assets stand out quickly and help customers notice and remember your brand.</p>
               </article>
               <article class="demand-map-card">
                  <h4>Consistent &amp; Professional Brand Experience</h4>
                  <p>Every visual, design, and campaign feels connected to one strong and recognizable brand identity.</p>
               </article>
               <article class="demand-map-card">
                  <h4>Higher Engagement &amp; Better Marketing Performance</h4>
                  <p>Creative content supports stronger campaign results, better audience interaction, and improved business growth.</p>
               </article>
            </div>
         </div>
      </div>
            ...
            <div class="col-lg-5" data-aos="fade-right">
               <div class="faq-split-visual">
                  ...
                  <div class="faq-img-wrap">
                     <img src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=900" alt="Creative strategy discussion">
                  ...
                  <div class="faq-list" id="maintFaqList">
                     <div class="faq-item">
                        <div class="faq-header">
                           <p class="faq-question">What are creative services for businesses?</p>
                           <i class="fas fa-chevron-down faq-icon" aria-hidden="true"></i>
                        </div>
                        <div class="faq-answer">
                           <p>Creative services focus on developing visual and content assets, including graphics, videos, branding materials, social media creatives, and marketing designs, for business communication.</p>
                        </div>
                     </div>
                     <div class="faq-item">
                        <div class="faq-header">
                           <p class="faq-question">Why are creative services important for marketing?</p>
                           <i class="fas fa-chevron-down faq-icon" aria-hidden="true"></i>
                        </div>
                        <div class="faq-answer">
                           <p>Creative content helps businesses attract attention, improve engagement, communicate ideas clearly, and create a stronger brand impression across digital platforms.</p>
                        </div>
                     </div>
                     <div class="faq-item">
                        <div class="faq-header">
                           <p class="faq-question">What types of creative content can businesses use?</p>
                           <i class="fas fa-chevron-down faq-icon" aria-hidden="true"></i>
                        </div>
                        <div class="faq-answer">
                           <p>Businesses can use social media creatives, website banners, brochures, videos, presentations, ad creatives, and branded marketing materials to support communication and promotions.</p>
                        </div>
                     </div>
                     <div class="faq-item">
                        <div class="faq-header">
                           <p class="faq-question">How do creative services support brand consistency?</p>
                           <i class="fas fa-chevron-down faq-icon" aria-hidden="true"></i>
                        </div>
                        <div class="faq-answer">
                           <p>Creative services ensure your business uses consistent colors, visuals, typography, and messaging across all marketing channels to strengthen brand recognition.</p>
                        </div>
                     </div>
                     <div class="faq-item">
                        <div class="faq-header">
                           <p class="faq-question">Can creative services improve customer engagement?</p>
                           <i class="fas fa-chevron-down faq-icon" aria-hidden="true"></i>
                        </div>
                        <div class="faq-answer">
                           <p>Yes, high-quality visuals and engaging content help businesses capture audience attention, increase interaction, and improve overall marketing performance.</p>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="col-lg-5" data-aos="fade-right">
               ...
               <ul class="contact-keypoints list-unstyled mb-0">
                  <li class="contact-keypoints__item">
                     <div>
                        <strong class="contact-keypoints__title">Strategy-Led Creative</strong>
                     </div>
                  </li>
                  <li class="contact-keypoints__item">
                     <div>
                        <strong class="contact-keypoints__title">Performance-Focused Output</strong>
                     </div>
                  </li>
                  <li class="contact-keypoints__item">
                     <div>
                        <strong class="contact-keypoints__title">Consistent Brand Look</strong>
                     </div>
                  </li>
                  <li class="contact-keypoints__item">
                     <div>
                        <strong class="contact-keypoints__title">Dedicated Creative Lead</strong>
                     </div>
                  </li>
               </ul>
            </div>
   ...
   <script>
      (function () {
          ...
          form.addEventListener('submit', function (e) {
            ...
            formData.append('form-field-d0e86ec', company ? company : 'Creative Services \u2014 Contact Form');
