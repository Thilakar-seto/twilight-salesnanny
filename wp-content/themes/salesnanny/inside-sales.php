   ...
   <section class="hero hero-d">
      ...
      <div class="container hero-d__container">
         <div class="hero-d__content" data-aos="fade-right" data-aos-duration="900">
            <h1 class="hero-d__h1">Convert Inquiries into Loyal Customers with Expert Pre-Sales Support</h1>
            <p class="hero-d__desc">
               We help businesses build strong pre-sales systems that respond faster, qualify better leads, and guide prospects smoothly from first inquiry to final conversion through structured follow-ups and lead management.
            </p>
      ...
      <div class="container">
         <div class="row align-items-end mb-5">
            <div class="col-lg-6" data-aos="fade-up">
               <h2 class="section-title">Core Pre-Sales Solutions for <span>Your Business</span></h2>
            </div>
            <div class="col-lg-5 offset-lg-1" data-aos="fade-up" data-aos-delay="100">
               <p class="section-sub">We don't just manage inquiries, we create a complete pre-sales process that keeps leads engaged, improves response quality, and helps your sales team close more deals with less wasted effort.</p>
            </div>
         </div>
         <div class="row g-4 mb-4">
            <div class="col-lg-5" data-aos="fade-up" data-aos-delay="50">
               <div class="service-img-wrap">
                  <img src="https://images.unsplash.com/photo-1553413077-190dd305871c?auto=format&fit=crop&q=80&w=900" alt="Lead qualification and pre-sales planning">
                  ...
                  <div style="position:absolute;bottom:24px;left:24px;z-index:2;">
                     ...
                     <div style="font-family:'Inter',sans-serif;font-size:22px;font-weight:800;color:#fff;">Lead Qualification &amp; Follow-Up</div>
                  </div>
               </div>
            </div>
            <div class="col-lg-7" data-aos="fade-up" data-aos-delay="100">
               <div class="service-img-wrap">
                  <img src="https://images.unsplash.com/photo-1471440671318-55bdbb772f93?auto=format&fit=crop&q=80&w=900" alt="Pre-sales process and conversion support">
                  <div class="service-img-overlay"></div>
                  <div style="position:absolute;bottom:24px;left:24px;z-index:2;">
                     <div style="font-size:0.75rem;color:rgba(255,255,255,0.6);text-transform:uppercase;letter-spacing:1px;">Program</div>
                     <div style="font-family:'Inter',sans-serif;font-size:22px;font-weight:800;color:#fff;">Structured Pre-Sales Workflow</div>
                  </div>
               </div>
            </div>
         </div>
         <div class="row g-4 align-items-center services-grid-compact">
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="100">
               <div class="service-card w-100">
                  ...
                  <p>Identify and prioritize high-potential leads so your sales team spends time only on prospects who are more likely to convert.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="150">
               <div class="service-card w-100">
                  ...
                  <h4>Lead Nurturing &amp; Follow-Up</h4>
                  <p>Keep prospects engaged through timely and professional follow-ups that prevent leads from going cold or moving to competitors.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="200">
               <div class="service-card w-100">
                  ...
                  <h4>Discovery Calls &amp; Requirement Gathering</h4>
                  <p>Understand customer needs early through structured conversations that qualify prospects before the sales process begins.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="250">
               <div class="service-card w-100">
                  ...
                  <h4>Proposal &amp; Quote Preparation</h4>
                  <p>Create professional proposals, quotations, and presentations that communicate your value clearly and improve customer confidence.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="300">
               <div class="service-card w-100">
                  ...
                  <h4>CRM Setup &amp; Lead Management</h4>
                  <p>Organize leads, conversations, and follow-ups in one streamlined system that improves visibility and sales coordination.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="350">
               <div class="service-card w-100">
                  ...
                  <p>Identify gaps in your sales process and improve lead movement through every stage to increase overall conversion rates.</p>
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="col-lg-5" data-aos="fade-right">
               <div class="position-relative">
                  <div class="about-img-grid">
                     <img src="https://images.unsplash.com/photo-1578575437130-527eed3abbec?auto=format&fit=crop&q=80&w=900" alt="Pre-sales team collaboration" style="height:220px;object-fit:cover;">
                     <img src="https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?auto=format&fit=crop&q=80&w=500" alt="Lead qualification planning" style="height:160px;object-fit:cover;">
                     <img src="https://images.unsplash.com/photo-1565728744382-61accd4aa148?auto=format&fit=crop&q=80&w=500" alt="Pre-sales process workshop" style="height:160px;object-fit:cover;">
                  </div>
               </div>
            </div>
            <div class="col-lg-6 offset-lg-1" data-aos="fade-left">
               <h2 class="section-title" style="color:#fff;">Why Pre-Sales Matters for Your Business?</span></h2>
               <p style="color:rgba(255,255,255,0.6);font-size:1rem;line-height:1.75;margin:20px 0 36px;font-weight:300;">Many businesses lose potential customers not because of poor services, but because inquiries are not handled properly. Strong pre-sales help you respond faster, build trust earlier, and convert more opportunities into revenue.</p>
               <div class="about-check-item">
                  <div class="check-icon"><i class="fas fa-check"></i></div>
                  <div>
                     <h6>Fast Follow-Ups Increase Conversions</h6>
                     <p>Most leads lose interest quickly when businesses delay responses. Timely follow-ups keep prospects engaged while interest is still high.</p>
                  </div>
               </div>
               <div class="about-check-item">
                  <div class="check-icon"><i class="fas fa-check"></i></div>
                  <div>
                     <h6>Better Qualification Saves Sales Time</h6>
                     <p>Without proper filtering, sales teams spend valuable time chasing leads that were never serious buyers in the first place.</p>
                  </div>
               </div>
               <div class="about-check-item">
                  <div class="check-icon"><i class="fas fa-check"></i></div>
                  <div>
                     <h6>Professional Communication Builds Trust</h6>
                     <p>A smooth and organized pre-sales experience creates confidence and leaves a strong first impression before the actual sale happens.</p>
                  </div>
               </div>
               <a href="#contact" class="btn-primary-hero mt-4" style="margin-top:36px;">
               Strengthen Your Pre-Sales <i class="fas fa-arrow-right"></i>
               </a>
            </div>
         </div>
      </div>
   ...
   <section id="process" class="process-section">
      <div class="container">
         <div class="text-center mb-5" data-aos="fade-up">
            <h2 class="section-title">What a Strong Pre-Sales System <span>Delivers for Businesses?</span></h2>
            <p class="section-sub mx-auto mt-3">Pre-sales is the bridge between marketing and sales. When done properly, it helps businesses convert more inquiries without increasing marketing spend.</p>
         </div>
         <div class="row g-4">
            <div class="col-md-6 col-lg-3 d-flex" data-aos="fade-up" data-aos-delay="50">
               <div class="process-step-card w-100">
                  ...
                  <h4>Faster Lead Response Times</h4>
                  <p>Respond to inquiries while customer interest is highest instead of losing leads through delayed communication.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-3 d-flex" data-aos="fade-up" data-aos-delay="100">
               <div class="process-step-card w-100">
                  ...
                  <h4>Higher Lead-to-Customer Conversion</h4>
                  <p>Qualified and nurtured leads are far more likely to convert compared to unstructured or cold inquiries.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-3 d-flex" data-aos="fade-up" data-aos-delay="150">
               <div class="process-step-card w-100">
                  ...
                  <h4>Cleaner &amp; More Efficient Sales Pipeline</h4>
                  <p>Your sales team focuses only on serious opportunities, improving productivity and reducing wasted effort.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-3 d-flex" data-aos="fade-up" data-aos-delay="200">
               <div class="process-step-card w-100">
                  ...
                  <h4>More Revenue from Existing Leads</h4>
                  <p>Convert a higher percentage of your current inquiries into customers without spending more on advertising or lead generation.</p>
               </div>
            </div>
         </div>
      </div>
   ...
   <section class="demand-map-section">
      <div class="container">
         <div class="demand-map-header" data-aos="fade-up">
            <h2 class="demand-map-title">The Difference Strong Pre-Sales <span>Makes for Your Business</span></h2>
            <p class="demand-map-desc">From missed responses and low-quality leads to structured communication and stronger conversions.</p>
         </div>
         <div class="demand-map-layout">
            <div class="demand-map-column demand-map-left" data-aos="fade-right">
               <article class="demand-map-card">
                  <h4>Slow or Missed Follow-Ups</h4>
                  <p>Leads lose interest or choose competitors because inquiries are not handled quickly enough.</p>
               </article>
               <article class="demand-map-card">
                  <h4>Sales Teams Chasing Low-Quality Leads</h4>
                  <p>Too much time is wasted on prospects who are unlikely to convert into paying customers.</p>
               </article>
               <article class="demand-map-card">
                  <h4>Inconsistent Customer Communication</h4>
                  <p>Different proposals, messaging, and responses create confusion and weaken customer confidence.</p>
               </article>
            </div>
            <div class="demand-map-center" data-aos="zoom-in" data-aos-delay="80">
               <div class="demand-phone" aria-hidden="true">
                  <div class="demand-phone-screen">
                     <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/home1.webp' ); ?>" alt="Pre-sales transformation visual">
                  </div>
               </div>
            </div>
            <div class="demand-map-column demand-map-right" data-aos="fade-left">
               <article class="demand-map-card">
                  <h4>Fast &amp; Professional Lead Engagement</h4>
                  <p>Every inquiry receives timely, consistent, and professional communication from the start.</p>
               </article>
               <article class="demand-map-card">
                  <h4>Sales Teams Focused on Qualified Leads</h4>
                  <p>Your team spends more time closing serious opportunities instead of filtering unqualified prospects.</p>
               </article>
               <article class="demand-map-card">
                  <h4>Clear &amp; Consistent Sales Communication</h4>
                  <p>Professional proposals and structured conversations create stronger customer trust and better conversion outcomes.</p>
               </article>
            </div>
         </div>
      </div>
            ...
            <div class="col-lg-5" data-aos="fade-right">
               <div class="faq-split-visual">
                  ...
                  <div class="faq-img-wrap">
                     <img src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=900" alt="Pre-sales strategy discussion">
                  ...
                  <div class="faq-list" id="maintFaqList">
                     <div class="faq-item">
                        <div class="faq-header">
                           <p class="faq-question">What is a presales service?</p>
                           <i class="fas fa-chevron-down faq-icon" aria-hidden="true"></i>
                        </div>
                        <div class="faq-answer">
                           <p>Presales services help businesses engage potential customers before the final purchase decision by qualifying leads, providing presentations, demos, proposals, and communication support.</p>
                        </div>
                     </div>
                     <div class="faq-item">
                        <div class="faq-header">
                           <p class="faq-question">Why is presales important for business growth?</p>
                           <i class="fas fa-chevron-down faq-icon" aria-hidden="true"></i>
                        </div>
                        <div class="faq-answer">
                           <p>Presales helps businesses improve customer understanding, respond faster to inquiries, and increase conversion opportunities through structured sales support.</p>
                        </div>
                     </div>
                     <div class="faq-item">
                        <div class="faq-header">
                           <p class="faq-question">What activities are included in presales support?</p>
                           <i class="fas fa-chevron-down faq-icon" aria-hidden="true"></i>
                        </div>
                        <div class="faq-answer">
                           <p>Presales support may include lead management, customer communication, proposal preparation, product presentations, requirement analysis, and follow-up coordination.</p>
                        </div>
                     </div>
                     <div class="faq-item">
                        <div class="faq-header">
                           <p class="faq-question">How does presales improve customer experience?</p>
                           <i class="fas fa-chevron-down faq-icon" aria-hidden="true"></i>
                        </div>
                        <div class="faq-answer">
                           <p>Presales creates a smoother buying journey by helping customers receive the right information, faster responses, and better guidance before making a decision.</p>
                        </div>
                     </div>
                     <div class="faq-item">
                        <div class="faq-header">
                           <p class="faq-question">Can presales services help improve conversions?</p>
                           <i class="fas fa-chevron-down faq-icon" aria-hidden="true"></i>
                        </div>
                        <div class="faq-answer">
                           <p>Yes, effective presales support helps businesses build trust, address customer concerns, and improve the chances of converting inquiries into customers.</p>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="col-lg-5" data-aos="fade-right">
               ...
               <ul class="contact-keypoints list-unstyled mb-0">
                  <li class="contact-keypoints__item">
                     <div>
                        <strong class="contact-keypoints__title">Trained Pre-Sales Team</strong>
                     </div>
                  </li>
                  <li class="contact-keypoints__item">
                     <div>
                        <strong class="contact-keypoints__title">Fast Lead Response</strong>
                     </div>
                  </li>
                  <li class="contact-keypoints__item">
                     <div>
                        <strong class="contact-keypoints__title">Process-Driven Approach</strong>
                     </div>
                  </li>
                  <li class="contact-keypoints__item">
                     <div>
                        <strong class="contact-keypoints__title">Dedicated Account Lead</strong>
                     </div>
                  </li>
               </ul>
            </div>
   ...
   <script>
      (function () {
          ...
          form.addEventListener('submit', function (e) {
            ...
            formData.append('form-field-d0e86ec', company ? company : 'Inside Sales \u2014 Contact Form');
