   ...
   <section class="hero hero-d">
      ...
      <div class="container hero-d__container">
         <div class="hero-d__content" data-aos="fade-right" data-aos-duration="900">
            <h1 class="hero-d__h1">
               <span class="hero-d__h1-red">Get High-Quality Leads</span> Within Days, Not Months
            </h1>
            <p class="hero-d__desc">
               Performance-driven Google Ads, Meta Ads, and LinkedIn campaigns built to bring qualified leads, lower your cost-per-lead, and scale your business fast.
            </p>
      ...
      <div class="container">
         <div class="row align-items-end mb-5">
            <div class="col-lg-6" data-aos="fade-up">
               <h2 class="section-title">CORE PAID MARKETING <span>SOLUTIONS</span></h2>
            </div>
            <div class="col-lg-5 offset-lg-1" data-aos="fade-up" data-aos-delay="100">
               <p class="section-sub">We don't just run ads, we build profitable ad systems that turn your ad spend into measurable revenue.</p>
            </div>
         </div>
         <div class="row g-4 mb-4">
            <div class="col-lg-5" data-aos="fade-up" data-aos-delay="50">
               <div class="service-img-wrap">
                  <img src="https://images.unsplash.com/photo-1553413077-190dd305871c?auto=format&fit=crop&q=80&w=900" alt="Google Ads strategy and analytics">
                  ...
                  <div style="position:absolute;bottom:24px;left:24px;z-index:2;">
                     ...
                     <div style="font-family:'Inter',sans-serif;font-size:22px;font-weight:800;color:#fff;">Paid Search &amp; PPC</div>
                  </div>
               </div>
            </div>
            <div class="col-lg-7" data-aos="fade-up" data-aos-delay="100">
               <div class="service-img-wrap">
                  <img src="https://images.unsplash.com/photo-1471440671318-55bdbb772f93?auto=format&fit=crop&q=80&w=900" alt="Paid media growth engine">
                  <div class="service-img-overlay"></div>
                  <div style="position:absolute;bottom:24px;left:24px;z-index:2;">
                     <div style="font-size:0.75rem;color:rgba(255,255,255,0.6);text-transform:uppercase;letter-spacing:1px;">Program</div>
                     <div style="font-family:'Inter',sans-serif;font-size:22px;font-weight:800;color:#fff;">Performance Ads Engine</div>
                  </div>
               </div>
            </div>
         </div>
         <div class="row g-4 align-items-center services-grid-compact">
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="100">
               <div class="service-card w-100">
                  ...
                  <h4>Google Ads</h4>
                  <p>High-intent campaigns that capture buyers actively searching for your services.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="150">
               <div class="service-card w-100">
                  ...
                  <h4>Meta Ads</h4>
                  <p>Audience-targeted campaigns that build awareness, drive clicks, and convert scrollers into buyers.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="200">
               <div class="service-card w-100">
                  ...
                  <h4>LinkedIn Ads</h4>
                  <p>B2B campaigns that put your brand in front of decision-makers and generate qualified leads.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="250">
               <div class="service-card w-100">
                  ...
                  <p>Engaging video campaigns that build brand recall and drive action across the funnel.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="300">
               <div class="service-card w-100">
                  ...
                  <h4>Retargeting &amp; Remarketing</h4>
                  <p>Re-engage website visitors and warm leads with smart retargeting that maximizes conversions.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="350">
               <div class="service-card w-100">
                  ...
                  <h4>Conversion Tracking &amp; Optimization</h4>
                  <p>Pixel setup, tracking, A/B testing, and ongoing optimization for the lowest possible cost-per-lead.</p>
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="col-lg-5" data-aos="fade-right">
               <div class="position-relative">
                  <div class="about-img-grid">
                     <img src="https://images.unsplash.com/photo-1578575437130-527eed3abbec?auto=format&fit=crop&q=80&w=900" alt="Paid marketing team collaboration" style="height:220px;object-fit:cover;">
                     <img src="https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?auto=format&fit=crop&q=80&w=500" alt="Campaign planning and optimization" style="height:160px;object-fit:cover;">
                     <img src="https://images.unsplash.com/photo-1565728744382-61accd4aa148?auto=format&fit=crop&q=80&w=500" alt="Performance ads workshop" style="height:160px;object-fit:cover;">
                  </div>
               </div>
            </div>
            <div class="col-lg-6 offset-lg-1" data-aos="fade-left">
               <h2 class="section-title" style="color:#fff;">Why Paid Marketing Matters for Your Business?</span></h2>
               <p style="color:rgba(255,255,255,0.6);font-size:1rem;line-height:1.75;margin:20px 0 36px;font-weight:300;">When you need leads NOW, not in 6 months, paid marketing is the fastest way to reach the right customers and grow.</p>
               <div class="about-check-item">
                  <div class="check-icon"><i class="fas fa-check"></i></div>
                  <div>
                     <h6>Instant Visibility, Instant Leads</h6>
                     <p>The moment your campaign goes live, your business shows up in front of buyers ready to take action.</p>
                  </div>
               </div>
               <div class="about-check-item">
                  <div class="check-icon"><i class="fas fa-check"></i></div>
                  <div>
                     <h6>Reach the Exact Audience You Want</h6>
                     <p>Target by location, interest, age, profession, or behavior. Your budget only goes to people who matter.</p>
                  </div>
               </div>
               <div class="about-check-item">
                  <div class="check-icon"><i class="fas fa-check"></i></div>
                  <div>
                     <h6>Predictable Growth You Can Scale</h6>
                     <p>Once a campaign is profitable, you can scale spend confidently and grow revenue on demand.</p>
                  </div>
               </div>
               <a href="#contact" class="btn-primary-hero mt-4" style="margin-top:36px;">
               Book a Free Ads Audit <i class="fas fa-arrow-right"></i>
               </a>
            </div>
         </div>
      </div>
   ...
   <section id="process" class="process-section">
      <div class="container">
         <div class="text-center mb-5" data-aos="fade-up">
            <h2 class="section-title">What You Can Expect From a <span>Well-Run Ad System?</span></h2>
            <p class="section-sub mx-auto mt-3">Done right, paid marketing isn't an expense, it's an ROI engine. Here's what businesses typically see:</p>
         </div>
         <div class="row g-4">
            <div class="col-md-6 col-lg-3 d-flex" data-aos="fade-up" data-aos-delay="50">
               <div class="process-step-card w-100">
                  ...
                  <h4>Faster Lead Flow Within Days</h4>
                  <p>Start receiving qualified inquiries from day one of campaign launch.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-3 d-flex" data-aos="fade-up" data-aos-delay="100">
               <div class="process-step-card w-100">
                  ...
                  <h4>Lower Cost-Per-Lead Over Time</h4>
                  <p>Continuous testing and optimization reduce your cost per acquisition month after month.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-3 d-flex" data-aos="fade-up" data-aos-delay="150">
               <div class="process-step-card w-100">
                  ...
                  <p>Sharper targeting plus optimized landing pages means more leads from the same budget.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-3 d-flex" data-aos="fade-up" data-aos-delay="200">
               <div class="process-step-card w-100">
                  ...
                  <h4>Predictable, Scalable Growth</h4>
                  <p>Once profitable, every additional rupee invested brings predictable returns.</p>
               </div>
            </div>
         </div>
      </div>
   ...
   <section class="demand-map-section">
      <div class="container">
         <div class="demand-map-header" data-aos="fade-up">
            <h2 class="demand-map-title">The Difference a Profitable Ad System <span>Makes for Your Business</span></h2>
            <p class="demand-map-desc">Before paid marketing: high spend and uncertainty. After paid marketing: predictable lead flow, clear tracking, and profitable growth.</p>
         </div>
         <div class="demand-map-layout">
            <div class="demand-map-column demand-map-left" data-aos="fade-right">
               <article class="demand-map-card">
                  <h4>High Ad Spend, Low Returns</h4>
                  <p>Money spent but no measurable business growth.</p>
               </article>
               <article class="demand-map-card">
                  <h4>Wrong Audience Reached</h4>
                  <p>Clicks come, but they are not the right buyers.</p>
               </article>
               <article class="demand-map-card">
                  <h4>No Tracking, No Insights</h4>
                  <p>You do not know what is working and what is not.</p>
               </article>
            </div>
            <div class="demand-map-center" data-aos="zoom-in" data-aos-delay="80">
               <div class="demand-phone" aria-hidden="true">
                  <div class="demand-phone-screen">
                     <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/home1.webp' ); ?>" alt="Paid marketing transformation visual">
                  </div>
               </div>
            </div>
            <div class="demand-map-column demand-map-right" data-aos="fade-left">
               <article class="demand-map-card">
                  <h4>Profitable, Trackable Campaigns</h4>
                  <p>Every rupee spent shows clear ROI.</p>
               </article>
               <article class="demand-map-card">
                  <h4>Right Audience, Right Time</h4>
                  <p>Ads reach the exact buyers ready to take action.</p>
               </article>
               <article class="demand-map-card">
                  <h4>Data-Driven Decisions</h4>
                  <p>Clear reports show what to scale and what to optimize.</p>
               </article>
            </div>
         </div>
      </div>
            ...
            <div class="col-lg-5" data-aos="fade-right">
               <div class="faq-split-visual">
                  ...
                  <div class="faq-img-wrap">
                     <img src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=900" alt="Paid marketing strategy discussion">
                  ...
                  <div class="faq-list" id="maintFaqList">
                     <div class="faq-item">
                        <div class="faq-header">
                           <p class="faq-question">What is paid marketing?</p>
                           <i class="fas fa-chevron-down faq-icon" aria-hidden="true"></i>
                        </div>
                        <div class="faq-answer">
                           <p>Paid marketing is a strategy that helps your business appear in front of potential customers through paid advertisements on search engines, social media platforms, and other digital channels.</p>
                        </div>
                     </div>
                     <div class="faq-item">
                        <div class="faq-header">
                           <p class="faq-question">Is paid marketing better than organic marketing?</p>
                           <i class="fas fa-chevron-down faq-icon" aria-hidden="true"></i>
                        </div>
                        <div class="faq-answer">
                           <p>Paid marketing helps businesses generate faster visibility and customer inquiries, while organic marketing supports long-term visibility and brand trust. Using both together creates stronger business growth.</p>
                        </div>
                     </div>
                     <div class="faq-item">
                        <div class="faq-header">
                           <p class="faq-question">What business growth can I expect from paid marketing?</p>
                           <i class="fas fa-chevron-down faq-icon" aria-hidden="true"></i>
                        </div>
                        <div class="faq-answer">
                           <p>Paid marketing helps your business reach targeted audiences quickly, generate inquiries faster, improve customer reach, and create more opportunities for sales and business growth.</p>
                        </div>
                     </div>
                     <div class="faq-item">
                        <div class="faq-header">
                           <p class="faq-question">What is an example of paid marketing?</p>
                           <i class="fas fa-chevron-down faq-icon" aria-hidden="true"></i>
                        </div>
                        <div class="faq-answer">
                           <p>Paid marketing examples include Google Search Ads, Facebook and Instagram Ads, YouTube video ads, display banner ads, and sponsored campaigns that help businesses reach targeted audiences and generate faster visibility and inquiries.</p>
                        </div>
                     </div>
                     <div class="faq-item">
                        <div class="faq-header">
                           <p class="faq-question">Why is paid marketing important for business?</p>
                           <i class="fas fa-chevron-down faq-icon" aria-hidden="true"></i>
                        </div>
                        <div class="faq-answer">
                           <p>As more customers search and spend time on digital platforms, paid marketing helps your business stay visible to the right audience and generate inquiries more quickly.</p>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="col-lg-5" data-aos="fade-right">
               ...
               <ul class="contact-keypoints list-unstyled mb-0">
                  <li class="contact-keypoints__item">
                     <div>
                        <strong class="contact-keypoints__title">ROI-Focused, Not Just Clicks</strong>
                     </div>
                  </li>
                  <li class="contact-keypoints__item">
                     <div>
                        <strong class="contact-keypoints__title">Daily Campaign Monitoring</strong>
                     </div>
                  </li>
                  <li class="contact-keypoints__item">
                     <div>
                        <strong class="contact-keypoints__title">Transparent Spend Reports</strong>
                     </div>
                  </li>
                  <li class="contact-keypoints__item">
                     <div>
                        <strong class="contact-keypoints__title">Dedicated Ads Strategist</strong>
                     </div>
                  </li>
               </ul>
            </div>
   ...
   <script>
      (function () {
          ...
          form.addEventListener('submit', function (e) {
             ...
             formData.append('form-field-d0e86ec', company ? company : 'Paid Marketing \u2014 Contact Form');
